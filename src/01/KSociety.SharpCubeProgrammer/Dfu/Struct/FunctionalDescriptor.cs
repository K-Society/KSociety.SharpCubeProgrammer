...
namespace SharpCubeProgrammer.Dfu.Struct
{
    ...
    public struct FunctionalDescriptor
    {
        ...
        private readonly byte bLength;

        /// <summary>
        ///  Descriptor type.
        /// </summary>
        public static readonly int Type = 0x21;
        private readonly byte bDescriptorType;
        ...
        private readonly Attributes bmAttributes;

        /// <summary>
        /// download capable
        /// </summary>
        public bool CanDownload { get { return (this.bmAttributes & Attributes.CanDnload) != 0; } }

        /// <summary>
        /// upload capable
        /// </summary>
        public bool CanUpload { get { return (this.bmAttributes & Attributes.CanUpload) != 0; } }

        /// <summary>
        /// device is able to communicate via USB after Manifestation phase.
        /// </summary>
        public bool ManifestationTolerant { get { return (this.bmAttributes & Attributes.ManifestationTolerant) != 0; } }
        ...
        /// </summary>
        public bool WillDetach { get { return (this.bmAttributes & Attributes.WillDetach) != 0; } }
        ...
        /// </summary>
        public int DetachTimeout { get { return this.wDetachTimeout; } }
        private readonly ushort wDetachTimeout;

        /// <summary>
        /// Maximum number of bytes that the device can accept per control-write transaction.
        /// </summary>
        public int TransferSize { get { return this.wTransferSize; } }
        private readonly ushort wTransferSize;

        /// <summary>
        /// Numeric expression identifying the version of the DFU Specification release.
        /// </summary>
        public Version DfuVersion { get { return new Version(this.bcdDFUVersion >> 8, this.bcdDFUVersion & 0xFF); } }
